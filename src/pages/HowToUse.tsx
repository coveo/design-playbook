    ...
    <div className="page howto">
        ...
        <p className="lead">
            The playbook is a collection of plays — workshops, sessions and frameworks — organised
        	 around how confident you are in the problem and the solution. Two minutes here and
            you&rsquo;ll know exactly how to read it.
        </p>
        ...
        <div className="howto-grid">
            <div className="howto-card">
                ...
                <div className="meter-scale">
                    <div className="row">
                        ...
                        <span>
                            Little is known — start framing the problem (e.g. Shaping Workshop)
                        </span>
                    </div>
                    <div className="row">
                        <ConfidenceMeter level={2} />
                        <span>
                            The problem is framed — explore and converge on ideas (e.g. Design
                            Smash, Storyboarding)
                        </span>
                    </div>
                    <div className="row">
            ...
            <div className="howto-card">
                ...
                <ul>
                    <li>
                        <strong>Understanding the problem</strong> — align on what we are solving
                        and why, before jumping to solutions.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Beyond the solution</strong> — test with users and feed what you
                        learn back into the loop.
                    </li>
                </ul>
                <p>
                    Stages are a compass, not a pipeline — plays tell you in their{' '}
                    <em>What next?</em> section where to go from there.
                </p>
            </div>
            ...
            <div className="howto-card">
                ...
                <p>
                    Hover any play link inside a page to preview it without leaving where you are.
                </p>
            </div>
            ...
            <div className="howto-card">
                <h2>Make it yours</h2>
                <p>
                    None of this is prescriptive. Each play can — and probably should — be adapted
                    to your team&rsquo;s needs and context. A good playbook is never finished.
                </p>
                <p>
                    Plays link to their tools where they exist: Miro templates for workshops and
                    agent skills (research synthesis, research narrative) that speed up the heavy
                    lifting. Want to add or improve a play? The playbook lives in a repo — open a
                    PR or ask the design team.
                </p>
            </div>
        </div>
    </div>
